...
def main():
    ...
    plotPersistance = True # change to "showPlots", and add a "savePlots" boolean -- make both of these print. testa
    ...
    QDC_canv.Print("raw_QDC_canv.png")
    
    TDC_canv, TDC_hist = make8x8("TDC", -100, 300, resolution, TDC)
    TDC_canv.Print("raw_TDC_canv.png")
